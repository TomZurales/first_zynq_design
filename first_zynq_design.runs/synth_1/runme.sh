...
HD_PWD='/home/tom/workspace/first_zynq_design/first_zynq_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_syste_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_syste_wrapper.tcl
